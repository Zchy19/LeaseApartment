...
import com.zchy.lease.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo) {
        IPage<ApartmentItemVo> page = apartmentInfoService.getListByPage(current, size, queryVo);
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        LambdaUpdateWrapper wrapper = new LambdaUpdateWrapper<ApartmentInfo>()
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        LambdaQueryWrapper wrapper = new LambdaQueryWrapper<ApartmentInfo>()
