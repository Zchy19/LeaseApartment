package com.zchy.lease.web.app.controller.appointment;
...
import com.zchy.lease.web.app.service.ViewAppointmentService;
...
public class ViewAppointmentController {
    ...
    public Result saveOrUpdate(@RequestBody ViewAppointment viewAppointment) {
        ...
        viewAppointment.setUserId(LoginUserHolder.getLoginUser().getId());
    ...
    public Result<List<AppointmentItemVo>> listItem() {
        List<AppointmentItemVo> list = service.listItemByUserId(LoginUserHolder.getLoginUser().getId());
