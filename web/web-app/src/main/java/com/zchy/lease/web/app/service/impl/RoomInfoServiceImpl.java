...
import com.zchy.lease.web.app.mapper.*;
import com.zchy.lease.web.app.service.ApartmentInfoService;
import com.zchy.lease.web.app.service.RoomInfoService;
import com.zchy.lease.web.app.vo.apartment.ApartmentItemVo;
...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    @Override
    public IPage<RoomItemVo> getAllList(long current, long size, RoomQueryVo queryVo) {
        Page<RoomItemVo> page = new Page<>(current, size);
        List<RoomItemVo> list = roomInfoMapper.getAllList(page, queryVo);
        page.setRecords(list);
        return page;
    }

    @Override
    public RoomDetailVo getDetaiById(Long id) {
        //1.查询房间信息
